...
export default function SparklesDemo() {
  return (
    <div className="space-y-10 py-10">
      <section>
        <h2 className="text-2xl font-bold text-center mb-4">Default Preview</h2>
        <SparklesPreview />
      </section>
      <section>
        <h2 className="text-2xl font-bold text-center mb-4">Dark Preview</h2>
        <SparklesPreviewDark />
      </section>
      <section>
        <h2 className="text-2xl font-bold text-center mb-4">Colorful Preview</h2>
